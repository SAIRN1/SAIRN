...
**124 files in `tools/`.** By what actually invokes them:
...
codebase and are pointed at it by nobody** -- 1 wired nowhere at all, and 15
...
```
  tools on disk                      124   git ls-files tools/
  ...
  tools invoked by tests/             74   tests/**/*.py, *.js
