...
Upstream path: skills/setup/domain-authentication/SKILL.md
Read in full before install, per standing rule. Changes made on install:
  - Corrected the DMARC reference. Upstream cited "RFC 9714 - DMARC (Standards Track, 2024)"; RFC 9714 is an unrelated IETF document (W. Cheng et al.), verified against rfc-editor.org. The DMARC standards-track RFC is 9989 (+9990/9991); 7489 is the 2015 Informational one.
...
- [RFC 9989](https://datatracker.ietf.org/doc/html/rfc9989) - DMARC (Standards Track), with
  [RFC 9990](https://datatracker.ietf.org/doc/html/rfc9990) (aggregate reporting) and
  [RFC 9991](https://datatracker.ietf.org/doc/html/rfc9991) (failure reporting);
  [RFC 7489](https://datatracker.ietf.org/doc/html/rfc7489) is the earlier Informational version
