...
**160 of 355 test files are traced to a stated requirement. 195 are not.**
...
```
  ...
  test files on disk                 355   tests/**, api/*.test.js
  open-work rows citing a test       146   docs\SAIRN-OPEN-WORK-INDEX.md
