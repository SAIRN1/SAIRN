...
| Requirement | Status | Proved by |
|---|---|---|
| The generic `DNT_RESOURCES` write validates `payload.id` and nothing else &mdash; **SEVENTEEN resources, not fifteen** | Open &mdash; **8 of 17 CLOSED, NINE REMAIN.** `dnt_txplans` 2026-09-11 (Hank). `dnt_procedure_types` 2026-09-09 (Fourth). `dnt_denial` 2026-09-05 (Cody). `dnt_patients` (guardian) and `dnt_gfe` (45 CF | `api/sd-data-dental-ledger-validation.test.js` |
...
**98 of 286 test files are traced to a stated requirement. 188 are not.**
