...
**182 of 385 test files are traced to a stated requirement. 203 are not.**
...
```
  ...
  test files on disk                 385   tests/**, api/*.test.js
  open-work rows citing a test       171   docs\SAIRN-OPEN-WORK-INDEX.md
