...
| **Four of the ten push-gate checks had never been PROVEN to refuse anything** &mdash; checks 1, 2, 3 and 5 had no probe that plants a finding and asserts a deny | **CHECKS 2 AND 5 NOW PROVEN 2026-09-12 (Cody)** &mdash; `tests/push_gate/check2_and_check5_probe.py`, 14 arms; 2 mutation controls bite, gate restored byte-identical. **1 and 3 remain unproven and say | `tests/push_gate/check2_and_check5_probe.py` |
...
**121 of 309 test files are traced to a stated requirement. 188 are not.**
