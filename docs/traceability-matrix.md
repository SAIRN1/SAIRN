...
| **Four of the ten push-gate checks had never been PROVEN to refuse anything** &mdash; checks 1, 2, 3 and 5 had no probe that plants a finding and asserts a deny | **CHECKS 2, 3 AND 5 NOW PROVEN** &mdash; 2 and 5 on 2026-09-12, **3 on 2026-09-13 (Cody)** via `tests/push_gate/check3_probe.py`, 30 arms; 4 mutation controls bite, gate restored byte-identical. **Onl | `tests/push_gate/check2_and_check5_probe.py`, `tests/push_gate/check3_probe.py` |
