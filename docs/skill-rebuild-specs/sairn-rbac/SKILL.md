...
**DRAFT REBUILD SPEC — not installed.** Lives in `docs/skill-rebuild-specs/`
pending review. See `docs/2026-08-30-skill-rebuild-classification.md` for why
this is first of nine.
