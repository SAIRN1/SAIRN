...
| **SAIRNlaw** | Deadline engine coverage: 9 jurisdictions (federal + 8 states), 97 rules | In progress | **Hank** | — | **Batch 1 complete: IL ✅ FL ✅ CA ✅. Batch 2 in progress: TX ✅ (`cc6899b`, 10 rules), NY next, then GA.** After GA the next decision is Michael's: more states, a third domain (family/probate/criminal), or an Ohio-neighbour track | L |
