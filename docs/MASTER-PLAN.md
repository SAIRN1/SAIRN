...
|---|---|---|---|
| `suites` | 362 | UNDER-counts | test files on disk attributed to no single app by path |
...
**WORST CASE: 448.** RSS for context: 368.
