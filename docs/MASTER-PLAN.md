...
|---|---|---|---|
| `suites` | 299 | UNDER-counts | test files on disk attributed to no single app by path |
...
**WORST CASE: 525.** RSS for context: 362.
...
```
  ...
  tests traced to a requirement    180   traceability_matrix.traced()
