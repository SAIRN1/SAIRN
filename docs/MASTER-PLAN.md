...
|---|---|---|---|
| `suites` | 290 | UNDER-counts | test files on disk attributed to no single app by path |
...
**WORST CASE: 513.** RSS for context: 353.
