...
|---|---|---|---|
| `suites` | 264 | UNDER-counts | test files on disk attributed to no single app by path |
...
```
  ...
  tests traced to a requirement    216   traceability_matrix.traced()
