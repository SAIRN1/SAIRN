...
|---|---|---|---|
| `suites` | 280 | UNDER-counts | test files on disk attributed to no single app by path |
...
**WORST CASE: 498.** RSS for context: 342.
