...
|---|---|---|---|
| `suites` | 303 | UNDER-counts | test files on disk attributed to no single app by path |
| `traced` | 216 | UNDER-counts | test files no source ties to a stated requirement |
...
**WORST CASE: 548.** RSS for context: 373.
