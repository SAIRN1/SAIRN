...
|---|---|---|---|
| `suites` | 277 | UNDER-counts | test files on disk attributed to no single app by path |
...
**WORST CASE: 494.** RSS for context: 339.
...
```
  ...
  tests traced to a requirement    164   traceability_matrix.traced()
