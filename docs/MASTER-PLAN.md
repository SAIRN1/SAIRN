...
|---|---|---|---|
| `suites` | 283 | UNDER-counts | test files on disk attributed to no single app by path |
| `traced` | 212 | UNDER-counts | test files no source ties to a stated requirement |
...
**WORST CASE: 523.** RSS for context: 355.
