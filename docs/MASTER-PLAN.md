...
| `traced` | 200 | UNDER-counts | test files no source ties to a stated requirement |
...
**WORST CASE: 511.** RSS for context: 351.
...
```
  ...
  tests traced to a requirement    171   traceability_matrix.traced()
