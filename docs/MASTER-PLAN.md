...
|---|---|---|---|
| `suites` | 282 | UNDER-counts | test files on disk attributed to no single app by path |
...
**WORST CASE: 501.** RSS for context: 345.
...
```
  ...
  tests traced to a requirement    167   traceability_matrix.traced()
