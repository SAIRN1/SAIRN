...
```
  ...
  test files on disk               613   tests/**, api/** (both walked)
  tests traced to a requirement    553   traceability_matrix.traced(), citations to files ON DISK only
