...
|---|---|---|---|
| `suites` | 272 | UNDER-counts | test files on disk attributed to no single app by path |
| `traced` | 194 | UNDER-counts | test files no source ties to a stated requirement |
...
**WORST CASE: 486.** RSS for context: 335.
