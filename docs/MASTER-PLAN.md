...
|---|---|---|---|
| `suites` | 279 | UNDER-counts | test files on disk attributed to no single app by path |
...
**WORST CASE: 496.** RSS for context: 341.
...
```
  ...
  tests traced to a requirement    166   traceability_matrix.traced()
