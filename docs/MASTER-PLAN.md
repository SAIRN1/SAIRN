...
| `traced` | 202 | UNDER-counts | test files no source ties to a stated requirement |
...
```
  ...
  declared fault probes             16   MUTATIONS blocks + *_fault_probe.py
