...
```
  ...
  test files on disk               523   tests/**, api/*.test.js
  tests traced to a requirement    509   traceability_matrix.traced()
  declared fault probes             55   MUTATIONS blocks + *_fault_probe.py + *_mutation_control.js + tests/faults/*.js
