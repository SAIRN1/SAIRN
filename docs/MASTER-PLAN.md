...
| `traced` | 193 | UNDER-counts | test files no source ties to a stated requirement |
...
**WORST CASE: 482.** RSS for context: 332.
...
```
  ...
  tests traced to a requirement    156   traceability_matrix.traced()
