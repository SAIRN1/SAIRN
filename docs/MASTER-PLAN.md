...
| `traced` | 210 | UNDER-counts | test files no source ties to a stated requirement |
...
**WORST CASE: 513.** RSS for context: 348.
...
```
  ...
  tests traced to a requirement    233   traceability_matrix.traced()
