...
| `traced` | 211 | UNDER-counts | test files no source ties to a stated requirement |
...
**WORST CASE: 514.** RSS for context: 348.
...
```
  ...
  tests traced to a requirement    232   traceability_matrix.traced()
