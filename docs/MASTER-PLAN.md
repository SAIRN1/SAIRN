...
|---|---|---|---|
| `suites` | 295 | UNDER-counts | test files on disk attributed to no single app by path |
...
**WORST CASE: 537.** RSS for context: 365.
...
```
  ...
  tests traced to a requirement    251   traceability_matrix.traced()
