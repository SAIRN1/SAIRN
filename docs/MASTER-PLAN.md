...
| `traced` | 13 | UNDER-counts | test files no source ties to a stated requirement |
...
**WORST CASE: 375.** RSS for context: 335.
...
```
  ...
  test files on disk               512   tests/**, api/*.test.js
