...
|---|---|---|---|
| `suites` | 306 | UNDER-counts | test files on disk attributed to no single app by path |
...
**WORST CASE: 533.** RSS for context: 368.
...
```
  ...
  tests traced to a requirement    187   traceability_matrix.traced()
