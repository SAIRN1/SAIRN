...
|---|---|---|---|
| `suites` | 300 | UNDER-counts | test files on disk attributed to no single app by path |
...
**WORST CASE: 545.** RSS for context: 371.
...
```
  ...
  tests traced to a requirement    253   traceability_matrix.traced()
