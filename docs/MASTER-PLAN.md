...
|---|---|---|---|
| `suites` | 326 | UNDER-counts | test files on disk attributed to no single app by path |
...
**WORST CASE: 360.** RSS for context: 327.
...
```
  ...
  tests traced to a requirement    503   traceability_matrix.traced()
