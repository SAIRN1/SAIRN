...
|---|---|---|---|
| `suites` | 281 | UNDER-counts | test files on disk attributed to no single app by path |
...
**WORST CASE: 499.** RSS for context: 343.
