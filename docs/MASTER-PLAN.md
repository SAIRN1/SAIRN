...
|---|---|---|---|
| `suites` | 286 | UNDER-counts | test files on disk attributed to no single app by path |
...
**WORST CASE: 528.** RSS for context: 358.
