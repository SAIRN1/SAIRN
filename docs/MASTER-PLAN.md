...
|---|---|---|---|
| `suites` | 291 | UNDER-counts | test files on disk attributed to no single app by path |
...
**WORST CASE: 535.** RSS for context: 363.
...
```
  ...
  tests traced to a requirement    245   traceability_matrix.traced()
