...
|---|---|---|---|
| `suites` | 289 | UNDER-counts | test files on disk attributed to no single app by path |
...
**WORST CASE: 532.** RSS for context: 361.
