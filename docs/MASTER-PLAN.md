...
|---|---|---|---|
| `suites` | 301 | UNDER-counts | test files on disk attributed to no single app by path |
...
**WORST CASE: 527.** RSS for context: 364.
...
```
  ...
  tests traced to a requirement    182   traceability_matrix.traced()
