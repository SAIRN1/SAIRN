...
| `traced` | 217 | UNDER-counts | test files no source ties to a stated requirement |
...
**WORST CASE: 536.** RSS for context: 364.
...
```
  ...
  tests traced to a requirement    243   traceability_matrix.traced()
