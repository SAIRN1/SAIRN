...
|---|---|---|---|
| `suites` | 296 | UNDER-counts | test files on disk attributed to no single app by path |
...
**WORST CASE: 538.** RSS for context: 366.
...
```
  ...
  tests traced to a requirement    252   traceability_matrix.traced()
