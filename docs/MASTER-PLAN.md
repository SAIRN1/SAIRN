...
```
  ...
  test files on disk               495   tests/**, api/*.test.js
  tests traced to a requirement    501   traceability_matrix.traced()
  declared fault probes             37   MUTATIONS blocks + *_fault_probe.py + *_mutation_control.js + tests/faults/*.js
