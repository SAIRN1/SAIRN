...
PURPOSES = {
    ...
    'run_graduated_exemption_probe.py': ('LIVE', 'a scoped push-gate exemption that is secretly blanket, or a "settling" phase that is decoration -- it drives the first push being REFUSED, the grant being consumed, and the pin dying when the tip sha moves'),
