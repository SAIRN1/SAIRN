...
check('exactly Alabama, Arkansas, Kansas, Maryland, Wisconsin, Massachusetts, Minnesota, Missouri and Virginia declare a coverage gap',
...
check('each coverage summary names its own jurisdiction',
  ['al', 'ar', 'ks', 'ma', 'md', 'mn', 'mo', 'va', 'wi'].filter(k => {
    const s = engine.JURISDICTION_COVERAGE[k].summary;
    return { al: /Alabama/, ar: /Arkansas/, ks: /Kansas/, ma: /Massachusetts|Suffolk/, md: /Maryland/, mn: /Minnesota|Indigenous/, mo: /Missouri/, va: /Virginia/, wi: /Wisconsin/ }[k].test(s);
  }), ['al', 'ar', 'ks', 'ma', 'md', 'mn', 'mo', 'va', 'wi']);
