...
check('exactly Alabama, Arkansas, Massachusetts, Minnesota, Missouri and Virginia declare a coverage gap',
...
check('each coverage summary names its own jurisdiction',
  ['al', 'ar', 'ma', 'mn', 'mo', 'va'].filter(k => {
    const s = engine.JURISDICTION_COVERAGE[k].summary;
    return { al: /Alabama/, ar: /Arkansas/, ma: /Massachusetts|Suffolk/, mn: /Minnesota|Indigenous/, mo: /Missouri/, va: /Virginia/ }[k].test(s);
  }), ['al', 'ar', 'ma', 'mn', 'mo', 'va']);
