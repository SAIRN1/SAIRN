...
check('exactly Alabama, Arkansas, Idaho, Kansas, Maryland, Wisconsin, Massachusetts, Minnesota, Mississippi, Missouri, Nebraska, New Mexico and Virginia declare a coverage gap',
  Object.keys(engine.JURISDICTION_COVERAGE).sort(), ['al', 'ar', 'id', 'ks', 'ma', 'md', 'mn', 'mo', 'ms', 'ne', 'nm', 'va', 'wi']);
...
check('each coverage summary names its own jurisdiction',
  ['al', 'ar', 'id', 'ks', 'ma', 'md', 'mn', 'mo', 'ms', 'ne', 'nm', 'va', 'wi'].filter(k => {
    const s = engine.JURISDICTION_COVERAGE[k].summary;
    return { al: /Alabama/, ar: /Arkansas/, id: /Idaho/, ks: /Kansas/, ma: /Massachusetts|Suffolk/, md: /Maryland/, mn: /Minnesota|Indigenous/, mo: /Missouri/, ms: /Mississippi/, ne: /Nebraska/, nm: /New Mexico/, va: /Virginia/, wi: /Wisconsin/ }[k].test(s);
  }), ['al', 'ar', 'id', 'ks', 'ma', 'md', 'mn', 'mo', 'ms', 'ne', 'nm', 'va', 'wi']);
