...
check('exactly Alabama, Arkansas, Florida, Idaho, Kansas, Maryland, Wisconsin, Massachusetts, Minnesota, Mississippi, Missouri, Nebraska, New Mexico and Virginia declare a coverage gap',
...
check('each coverage summary names its own jurisdiction',
  ['al', 'ar', 'fl', 'id', 'ks', 'ma', 'md', 'mn', 'mo', 'ms', 'ne', 'nm', 'va', 'wi'].filter(k => {
    const s = engine.JURISDICTION_COVERAGE[k].summary;
    return { al: /Alabama/, ar: /Arkansas/, fl: /Florida/, id: /Idaho/, ks: /Kansas/, ma: /Massachusetts|Suffolk/, md: /Maryland/, mn: /Minnesota|Indigenous/, mo: /Missouri/, ms: /Mississippi/, ne: /Nebraska/, nm: /New Mexico/, va: /Virginia/, wi: /Wisconsin/ }[k].test(s);
