...
check('each coverage summary names its own jurisdiction',
  ['al', 'ar', 'de', 'fl', 'hi', 'id', 'ks', 'ma', 'md', 'mn', 'mo', 'ms', 'ne', 'nh', 'nm', 'nv', 'ut', 'va', 'wi'].filter(k => {
    const s = engine.JURISDICTION_COVERAGE[k].summary;
    return { al: /Alabama/, ar: /Arkansas/, fl: /Florida/, hi: /Hawai/, id: /Idaho/, ks: /Kansas/, ma: /Massachusetts|Suffolk/, md: /Maryland/, mn: /Minnesota|Indigenous/, mo: /Missouri/, ms: /Mississippi/, ne: /Nebraska/, nh: /New Hampshire/, de: /Delaware|Chancery|Prothonotary/, nm: /New Mexico/, nv: /Nevada/, ut: /Utah/, va: /Virginia/, wi: /Wisconsin/ }[k].test(s);
