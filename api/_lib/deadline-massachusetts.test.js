...
check('exactly Alabama, Arkansas, Delaware, Florida, Hawaii, Idaho, Kansas, Maine, Maryland, Wisconsin, Massachusetts, Minnesota, Mississippi, Missouri, Montana, Nebraska, Nevada, New Hampshire, New Mexico, Pennsylvania, Utah and Virginia declare a coverage gap',
...
check('each coverage summary names its own jurisdiction',
  ['al', 'ar', 'de', 'fl', 'hi', 'id', 'ks', 'ma', 'md', 'me', 'mn', 'mo', 'ms', 'mt', 'ne', 'nh', 'nm', 'nv', 'pa', 'ut', 'va', 'wi'].filter(k => {
    const s = engine.JURISDICTION_COVERAGE[k].summary;
    return { al: /Alabama/, ar: /Arkansas/, fl: /Florida/, hi: /Hawai/, id: /Idaho/, ks: /Kansas/, ma: /Massachusetts|Suffolk/, md: /Maryland/, me: /Maine|MAINE/, mn: /Minnesota|Indigenous/, mo: /Missouri/, ms: /Mississippi/, mt: /Montana|Justice and City Court/, ne: /Nebraska/, nh: /New Hampshire/, de: /Delaware|Chancery|Prothonotary/, nm: /New Mexico/, nv: /Nevada/, pa: /Pennsylvania/, ut: /Utah/, va: /Virginia/, wi: /Wisconsin/ }[k].test(s);
  }), ['al', 'ar', 'de', 'fl', 'hi', 'id', 'ks', 'ma', 'md', 'me', 'mn', 'mo', 'ms', 'mt', 'ne', 'nh', 'nm', 'nv', 'pa', 'ut', 'va', 'wi']);
